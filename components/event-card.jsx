...
>
  ...
  return (
   <Card
  className={`overflow-hidden group pt-0 bg-gray-950 border-gray-700 text-white ${onClick ? "cursor-pointer hover:shadow-lg transition-all hover:border-purple-500/50" : ""} ${className}`}
  onClick={onClick}
>
